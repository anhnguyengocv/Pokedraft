Pokedraft is an application provides and displays data of 200 Pokemon when cliked on their names, including height, types, and abilities. Users can look up Pokemon by using search bar.
